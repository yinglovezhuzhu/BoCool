 ...
 */
package com.xiaoying.bocool.widget.slidingmenu;
...
import com.xiaoying.bocool.widget.slidingmenu.SlidingMenu.OnClosedListener;
import com.xiaoying.bocool.widget.slidingmenu.SlidingMenu.OnOpenedListener;

//import com.slidingmenu.lib.SlidingMenu.OnCloseListener;
//import com.slidingmenu.lib.SlidingMenu.@deprecated 不使用ViewPage，将会被删掉OnOpenListener;
...
//		mContent.setClickable(true);
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (action == MotionEvent.ACTION_DOWN && DEBUG) {
			LogUtils.v(TAG, "Received ACTION_DOWN");
		}
